...
### manually paste buffer into https://decaffeinate-project.org/repl/#?useCS2=true&useJSModules=false&loose=false&optionalChaining=false&evaluate=true&stage=full&code=
